...
public class WarmupTasks {
    public static void main(String[] args) {
        ...
        letters.removeIf(p -> !Character.isLetter(p)); //removed the characters that are not letters

        System.out.println("letters = " + letters);

        ArrayList<Character> digits = new ArrayList<>(chars);//added all the characters
        digits.removeIf(p-> !Character.isDigit(p));//removed the characters that are not digits
