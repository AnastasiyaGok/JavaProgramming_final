...
/*
 Creat a class named ScrumTeam:
			...
			Methods:
				...
				addDevelopers(Developer[] developers): adds the given developers to testers arraylist

				removeDeveloper(int id): removes the developer with the given id from the arraylist of developers
