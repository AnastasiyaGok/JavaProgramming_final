...
public class ReplaceAll {
    public static void main(String[] args) {
        ...
        arr = replaseAll(arr, 30, 300);
        System.out.println(Arrays.toString(arr));

        arr = replaseAll(arr, 300,500);
        System.out.println(Arrays.toString(arr));
    }

    //replaces all the matching old values of the array with the new value
    public static int[] replaseAll(int[] array, int oldValue, int newValue){
    ...
    //replaces all the matching old values of the array with the new value
    public static double[] replaseAll(double[] array, double oldValue, double newValue){
    ...
    //replaces all the matching old values of the array with the new value
    public static char[] replaseAll(char[] array, char oldValue, char newValue){
    ...
    //replaces all the matching old values of the array with the new value
    public static String[] replaseAll(String[] array, String oldValue, String newValue){
